...
namespace CarServiceMate.Services
{
    ...
    public class AccountService : IAccountService
    {
        ...
        public AccountService(CarServiceMateDbContext dbContext, IPasswordHasher<User> passwordHasher,
        ...
        public string GenerateJwt(LoginDto dto)
        {
            var user = _dbContext.Users.Include(p => p.Role).FirstOrDefault(u => u.Email == dto.Email);
            if( user is null)
            {
